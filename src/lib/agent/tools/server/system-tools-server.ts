...
export const systemToolsServer: AgentTool[] = [
  {
    id: 'system_execute',
    name: 'Execute Command',
    description: 'Execute system commands (server-side only)',
    category: 'system',
    parameters: {
  ...
  },
  {
    ...
    description: 'Get system information (server-side only)',
    category: 'system',
    parameters: {
  ...
  },
  {
    ...
    description: 'Manage system processes (server-side only)',
    category: 'system',
    parameters: {
  ...
  },
  {
    ...
    description: 'Perform filesystem operations (server-side only)',
    category: 'system',
    parameters: {
  ...
  },
  {
    id: 'system_monitor',
    name: 'System Monitor',
    description: 'Monitor system resources (server-side only)',
    category: 'system',
    parameters: {
